    ...
    <div>
        <v-row class="mb-3">
            <v-col cols="12">
                ...
                <v-text-field variant="outlined" class="pwdInput" hide-details color="primary" v-model="state.usrname"></v-text-field>
            </v-col>
            <v-col cols="12">
            ...
            <v-col cols="12">
                <v-btn size="large" rounded="pill" color="primary" class="rounded-pill" block type="submit" flat @click="onSubmit">Sign
                    In</v-btn>
            </v-col>
        </v-row>
    </div>
