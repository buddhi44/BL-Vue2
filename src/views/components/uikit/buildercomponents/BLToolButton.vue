...
@Component
class blToolButton extends Vue implements IUIDefinition{
...
export default toNative(blToolButton)
...
<template>
    <v-tooltip :text="UiElement.elementCaption" >
        <template v-slot:activator="{props}">
            <v-btn :onclick="(e:any) => onButtonClicked(e)" v-bind="props" color="primary" size="medium" density="comfortable" flat  :class="`${props.UiElement?.cssClass}`" :icon="myicon"></v-btn>
        </template>
    </v-tooltip>
</template>
